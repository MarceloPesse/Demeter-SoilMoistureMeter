# Django settings for si_demeter project.
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
STATIC_ROOT = PREFIXO1+'/static/'

# URL prefix for static files.
# Example: "http://media.lawrence.com/static/"
STATIC_URL = PREFIXO2+'/static/'
...
SECRET_KEY = 'c6tgc04f!3+$=)_i&amp;x^!_rk0n8_45zet0p9zjzrr1&amp;5yhuf9r2'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "si_demeter.context_processors.context_principal"
    )
...
WSGI_APPLICATION = 'si_demeter.wsgi.application'

TEMPLATE_DIRS = (
    PREFIXO1+'sistema/templates',
